...
<body class="d-flex flex-column min-vh-100">
    ...
    <section class="bg-primary text-white text-center py-5">
        <div class="container">
            ...
            <a href="${pageContext.request.contextPath}/vistas/login.jsp" class="btn btn-light btn-lg mt-3">Solicita tu financiamiento</a>
        </div>
    </section>
    ...
    <section class="py-5 bg-light text-center">
        <div class="container">
            <h2 class="mb-4">Simula tu financiamiento</h2>
            <div class="row justify-content-center">
                <div class="col-md-6">
                    <div class="card shadow-lg border-0">
                        <div class="card-body">
                            <h5 class="card-title mb-4 text-primary">
                                <i class="bi bi-calculator-fill me-2"></i>Calculadora de cuotas
                            </h5>
                            <form>
                                ...
                                <button type="button" class="btn btn-success w-100 fw-bold" onclick="calcularCuota()">
                                    <i class="bi bi-currency-dollar me-1"></i>Calcular cuota mensual
                                </button>
