                        ...
                        <tbody>
                            <c:forEach var="reclamo" items="${reclamos}">
                                <tr>
                                    <td>${reclamo.id}</td>
                                    <td>
                                        <span class="badge ${reclamo.tipo == 'Reclamo' ? 'bg-danger' : 'bg-warning'}">
                                            ${reclamo.tipo}
                                        </span>
                                    </td>
                                    ...
                                    <td>
                                        <fmt:formatDate value="${reclamo.fecha}" pattern="dd/MM/yyyy HH:mm"/>
                                    </td>
                                    <td>
                                        <button class="btn btn-sm btn-danger" 
                                                onclick="if(confirm('¿Eliminar?')) window.location.href='${pageContext.request.contextPath}/libro?accion=eliminar&id=${reclamo.id}'">
