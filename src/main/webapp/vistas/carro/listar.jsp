                        ...
                        <c:forEach var="c" items="${listaCarros}">
                            <tr>
                                ...
                                <td class="text-center">
                                    <img src="${pageContext.request.contextPath}/img/${c.imagen}" alt="${c.nombre}" width="80" class="rounded shadow-sm">
                                </td>
                                <td class="fw-bold text-success">S/. ${c.precio}</td>
                                <td class="text-center">
                                    <a href="${pageContext.request.contextPath}/carro?accion=editar&id=${c.id}" class="btn btn-sm btn-warning rounded-pill me-1">
                                        <i class="bi bi-pencil-square"></i> Editar
                                    </a>
                                    <a href="${pageContext.request.contextPath}/carro?accion=eliminar&id=${c.id}" class="btn btn-sm btn-danger rounded-pill"
