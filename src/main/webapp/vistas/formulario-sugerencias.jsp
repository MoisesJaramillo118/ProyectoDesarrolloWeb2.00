                        ...
                        <div class="card-body p-4">
                            ...
                            <form id="formSugerencia" novalidate>
                                ...
                                <div class="mb-3">
                                    ...
                                    <div class="invalid-feedback">Escribe tu sugerencia.</div>
                                </div>
        ...
        $(document).ready(function () {
            ...
            $('#formSugerencia').on('submit', function (event) {
                ...
                $.ajax({
                    ...
                    data: datos,
                    dataType: 'json',
                    headers: { 'X-Requested-With': 'XMLHttpRequest' }, // 👈 clave para que el servlet lo reconozca como AJAX
                    success: function (resp) {
                        ...
                        if (resp.success) {
                            ...
                            $('#formSugerencia')[0].reset();
                            $('#formSugerencia').removeClass('was-validated');
                        } else {
                            $('.card-body').prepend(
